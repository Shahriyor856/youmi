...
import image from "@/assets/images/Слой 2 (1).svg";
...
const faqData = [
  {
    ...
    content:
      "Да, эффективно и уже является стандартной практикой во всем мире...",
  },
  {
    name: "2",
  ...
  {
    name: "5",
    title: "В чем разница между психологом, психотерапевтом и психиатром?",
    content: "Ответ на вопрос...",
  },
  {
    name: "6",
...
<template>
  <UiHeaderUI :image-src="image" />
  <UiThreeCards
    :cards="cardsTwo"
    main-title="Онлайн-психотерапия становится комфортнее"
  />
  <ModulesMainPageCarusel />
  <ModulesMainPageFourTable
    title="Мы работаем только с"
    text="квалифицированными специалистами, которые прошли наш строгий отбор"
    text-t
    wo="Помимо серии собеседований и испытаний по разработанной нами методологии, психологи предоставляют необходимые документы:"
  />
